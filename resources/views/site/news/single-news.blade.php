        ...
        <div class="section-one-content single-news container mx-auto">
            ...
            <div class="news_body_main">
                ...
                <div class="first-content">
                    ...
                    <p class="text-white first-content-category-icon"><span class="iconify text-white" data-icon="ic:sharp-radio-button-checked" data-inline="false"></span>{{ $post->category->name }}</p>
