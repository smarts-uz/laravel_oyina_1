    ...
    <section class="single_book_back_layer" >
        ...
        <div class="all_books all_books_single_rows container mx-auto relative">
            ...
            <div class="single_book_second_head">
                <h1>ISLOM Temuriylar tarixi davlat muzeyi durdonasi...</h1>
                <div class="single_bokks_inline_btn">
                    ...
                    <a href="../audios/a.mp3" download><span style="display:inline" class="iconify" data-icon="entypo:download" data-inline="false"></span> Yuklab olish</a>
                </div>
    ...
    <section class="all_books container mx-auto">
        <div class="single_books_rows">
            ...
            <div class="single_book_second">
                ...
                <div class="info_book">
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptatem voluptatibus fugit, saepe animi esse iure eveniet assumenda obcaecati deleniti reiciendis atque ab incidunt, rerum cumque numquam alias architecto officiis asperiores.</p>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Veritatis reprehenderit enim praesentium nostrum. Nihil necessitatibus dolor sit fuga, velit error temporibus eligendi impedit eveniet, iste neque quis vel consequuntur iure.</p>
                </div>
                                ...
                                <div class="rating">
                                    ...
                                    <div class="emoji-wrapper">
                                        <div class="emoji">
                                            ...
                                            <svg class="rating-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                                                <path d="M407.7 352.8a163.9 163.9 0 0 1-303.5 0c-2.3-5.5 1.5-12 7.5-13.2a780.8 780.8 0 0 1 288.4 0c6 1.2 9.9 7.7 7.6 13.2z" fill="#3e4347"/>
                                                <path d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z" fill="#f4c534"/>
                                                <g fill="#fff">
                                            ...
                                            <svg class="rating-7" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <circle cx="256" cy="256" r="256" fill="#ffd93b"/>
                                                <path d="M512 256A256 256 0 0 1 56.7 416.7a256 256 0 0 0 360-360c58.1 47 95.3 118.8 95.3 199.3z" fill="#f4c534"/>
                                            ...
                                            <svg class="rating-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                <g fill="#ffd93b">
