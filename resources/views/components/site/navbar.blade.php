...
{{--                <li><a class="active-link" href="/">@lang('site.header.main_page')</a></li>--}}
{{--                <li><a class="" href="#">@lang('site.header.news')</a></li>--}}
{{--                <li><a class="" href="#">@lang('site.header.articles')</a></li>--}}
{{--                <li><a class=" " href="{{ route('multimedia') }}">@lang('site.header.media')</a></li>--}}
{{--                <li><a class=" " href="#">@lang('site.header.library')</a></li>--}}
{{--                <li><a class="" href="#">@lang('site.header.official')</a></li>--}}
{{--                <li><a class=" " href="#">@lang('site.header.chaqs')</a></li>--}}
{{--                <li><a class=" " href="#">@lang('site.header.announcement')</a></li>--}}
                @foreach(menu('site_uz', '_json') as $item)
                    <li><a  target="{{ $item->target }}"  href="{{ $item->url }}">{{ $item->title }}
                           </a></li>
                @endforeach
            </ul>
        </div>
            ...
            <div class="nav-col-2 flex items-center">
                <div x-data="{ dropdownOpen: false }" class="relative">
                    ...
                    <div x-show="dropdownOpen" class="absolute dropdow right-0 mt-2 py-2 w-48 bg-white rounded-md shadow-xl z-20">
                        <a onchange="document.getElementById('change_lang_value').innerHTML = this.innerHTML" href="/uz-Latn" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-green-500 hover:text-white">
                            O'zbek1
                        </a>
                        ...
                        <a href="/uz" class="block px-4 py-2 text-sm capitalize text-gray-700 hover:bg-green-500 hover:text-white">
                            Ўзбек
                        </a>
                    </div>
                </div>
                ...
                <div>
                    {{--  --}}
                    <a class="flex flex-row text-lg font-normal text-white items-center" href="{{ route('login') }}">
